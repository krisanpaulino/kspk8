                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-4">
                                ...
                                <input type="datetime-local" class="form-control <?= (isset(session('errors')['published_at'])) ? 'is-invalid' : '' ?>" id="published_at" name="published_at" value="<?= esc(old('published_at', isset($artikel->published_at) && $artikel->published_at ? date('Y-m-d H:i:s', strtotime($artikel->published_at)) : '')) ?>">
                                <div class="invalid-feedback">
